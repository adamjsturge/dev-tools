...
<nav class="flex items-center justify-between bg-ctp-crust p-4 text-ctp-text">
	...
	<div class="flex max-w-fit rounded ml-auto">
		<a href='https://ko-fi.com/I2I2TZ4OC' target='_blank'><img height='36' style='border:0px;height:36px;' src='https://storage.ko-fi.com/cdn/kofi6.png?v=6' alt='Buy Me a Coffee at ko-fi.com' /></a>
        <a href="https://github.com/adamjsturge/dev-tools" target="_blank" rel="noopener noreferrer" class="ml-4 flex items-center">
